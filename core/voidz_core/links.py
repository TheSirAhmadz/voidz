...
Covers the protocols Voidz Core supports (MTProto is not part of
Voidz Core v1).
"""
...
def generate_share_link(link: Link, host: str, remark_prefix: str = "Voidz",
                        path_prefix: str = "") -> str:
...
def subscription_payload(links: list[Link], host: str, title: str = "Voidz") -> tuple[str, dict]:
