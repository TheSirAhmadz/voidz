"""FastAPI application assembly for Voidz Core.
...
* Management API (Bearer token via VOIDZ_CORE_API_TOKEN), consumed by the
  Voidz Worker on behalf of the Console:
...
class Core:
    ...
    def __init__(self, cfg: CoreConfig):
        ...
        self.app = FastAPI(title="Voidz Core", docs_url=None, redoc_url=None,
