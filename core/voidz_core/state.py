"""State management for Voidz Core.

Central, explicitly-locked stores instead of module-level globals:
...
class Link:
    ...
    Each link is identified by a UUID, carries a traffic quota and expiry,
    and can be disabled or enabled without restarting the runtime.
    """
...
class StateStore:
    """Atomic JSON persistence with debounced saves. Corrupt files are
    renamed aside, never crash boot."""
