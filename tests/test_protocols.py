"""Voidz Core protocol unit tests: VLESS/Trojan header codecs, SS AEAD
...
import voidz_core.relay.vless as vless_mod
from voidz_core.relay.trojan import (
    build_trojan_request,
    parse_trojan_request,
    trojan_password_hash,
)
from voidz_core.relay.vless import build_vless_header, parse_vless_header
from voidz_core.state import Link
...
def test_ss_aead_roundtrip():
    from voidz_core.relay.shadowsocks import AEADStream, derive_key
