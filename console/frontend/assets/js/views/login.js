    ...
    <div class="login-wrap">
      <div class="login-card">
        <div class="brand" style="justify-content:center">
          <span class="brand-mark">${markLarge}</span>
        </div>
        <h2 style="margin:0 0 2px;font-size:24px;letter-spacing:.3px;font-weight:750">Voidz</h2>
        <div class="card">
          <p class="pitch" style="margin-top:2px">Deploy and manage multi-protocol proxy instances.<br>One click. Zero servers to babysit.</p>
          ${ghSection}
          ${setupSection}
...
export default { render: renderLogin };
export const requireAuth = renderLogin;
