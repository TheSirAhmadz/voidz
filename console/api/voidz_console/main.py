"""Voidz Console API — ASGI application.
...
setup_logging()
log = get("runtime", "voidz.console")

FRONTEND_DIR = Path(__file__).resolve().parents[2] / "frontend"

app = FastAPI(title="Voidz Console", docs_url=None, redoc_url=None,
...
@app.get("/health")
async def health():
    return {"status": "ok", "service": "Voidz Console", "version": version.version()}
